...
$sql = "SELECT uid, username, mobile_No,Email,address FROM tutorial.login";
...
if ($result->num_rows > 0) {
  ...
  $a=1;
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $a. "</td><td>" . $row["username"]. " </td><td>" . $row["mobile_No"]. "</td><td>" . $row["Email"]. "</td><td>" . $row["address"]. "</td></tr>";
        $a++;
    }
    echo "</table>";
} else {
