                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav text-center mx-auto">
                        <li class="nav-item  mr-lg-4 mt-lg-0 mt-sm-4 mt-3">
                            <a class="hover-fill" href="View_customers.php" data-txthover="View Customers">View Customers</a>
                        </li>
                        <li class="nav-item  mr-lg-4 mt-lg-0 mt-sm-4 mt-3">
                            <a class="hover-fill" href="calculate_bill.php" data-txthover="Calculate Bill">Calculate Bill</a>
                        </li>
                        <li class="nav-item mr-lg-4 my-lg-0 my-sm-4 my-3">
                            <a class="hover-fill" href="update.php" data-txthover="update">update</a>
                        </li>
                        <li class="nav-item mr-lg-4 my-lg-0 mb-sm-4 mb-3">
                            <a class="hover-fill" href="viewfeedback.php" data-txthover="view feedback">view feedback</a>
                        </li>
                    <li class="nav-item mr-lg-4 my-lg-0 mb-sm-4 mb-3">
                            <a class="hover-fill" href="Register_form.php" data-txthover="Register">Register</a>
                        </li>
                        
                    </ul>
                    <a href="logout.php"> <button type="submit"  class="btn bg-theme w3ls-btn text-uppercase font-weight-bold d-block" data-toggle="modal"
